	...
	module Skins
		...
		module OSC
			...
			@keys = {:d_bg => ["D_Bg", "Pictures"],
							 ...
							 :notes_skin => ["notes_skin", "Windowskins"],
							 :menu_back => ["menu-back", "SkinFiles"],
							 :menu_enter => ["play-skip", "SkinFiles"]
							}
			...
			def self.get_file(id)
				...
				return System::Skins::Osu.get_file(@keys[id][0]) if @syncs.include? id
				...
				std_name += FileTest.exist?(std_name + ".png") ? ".png" : ".jpg"
